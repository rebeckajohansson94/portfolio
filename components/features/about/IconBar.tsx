  ...
  return (
    <section className="bg-lavender-deep py-16 px-8">
      <div className="flex items-center justify-center divide-x divide-white/20">
        <div className="flex flex-col items-center gap-3 px-4 sm:px-8 md:px-16 text-center">
          <Infinity size={32} className="text-white" />
          <p className="text-white/70 text-xs tracking-[0.15em] sm:tracking-[0.3em] uppercase font-bold">
            Always learning
          </p>
        </div>
