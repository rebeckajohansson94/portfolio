      ...
      <div className="relative z-10 max-w-350 mx-auto flex flex-col md:flex-row items-center justify-center gap-0">
        <div className="flex flex-col gap-4 pr-24">
          ...
          >
            ...
            <span className="text-8xl italic font-light block">Together!</span>
          </h2>
        </div>

        {/* line-divider */}
        <div className="hidden md:block w-px h-40 bg-white/20 mx-8" />

        <div className="flex flex-col gap-6 min-w-80 pl-16">
          <div>
            <p
